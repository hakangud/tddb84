\message{ !name(hakgu806_TDDB84_upg1_HT2015.tex)}
%% bare_conf.tex
%% V1.4b
%% 2015/08/26
%% by Michael Shell
...
\message{ !name(hakgu806_TDDB84_upg1_HT2015.tex) !offset(-3) }
...
\begin{abstract}
  ...
  The subject software quality is defined and metrics suitable for measuring maintainability and understandability are chosen.
  
  The findings are analyzed and discussed.
...
The concept of design patterns was brought up by the architect Christoffer Alexander, in 1977, as solution to common problems in architectural designs.
...
In the study \cite{complexity} the authors list some of the major principles behind Object-Oriented paradigm and their impact on software complexity, one of them being inheritance.
Inheritance\footnote{\url{https://docs.oracle.com/javase/tutorial/java/IandI/subclasses.html}} makes it possible to create a class that is based on an other class and inherits methods and fields from that class.
...
% lägg vikt på hur attraktivt maintainability är jämfört med understandability
% generellt sett bättre att fokusera på maintainability 
\section{Conclusion}
...
The software quality maintainability is related to coupling and understandability is related to inheritance.
...
In the game FreeCol the Factory Method pattern decrease coupling but also creates a lot of subclasses.
...
\message{ !name(hakgu806_TDDB84_upg1_HT2015.tex) !offset(-942) }
